 ...
 */
public class MultitouchPlot extends XYPlot implements OnTouchListener, OnLongClickListener {
        ...
        if (minXSeriesValue != null && maxXSeriesValue != null) {
            switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_POINTER_UP: // end zoom
                    ...
                    // left?
                    if (timeDown > 0 && (mode == NONE || mode == ONE_FINGER_DRAG)) {
                        long passed = System.currentTimeMillis() - timeDown;
                        if (passed >= ViewConfiguration.getLongPressTimeout())
    ...
    public boolean onLongClick(View v) {
        setDomainLowerBoundary(0, BoundaryMode.AUTO);
        setDomainUpperBoundary(0, BoundaryMode.AUTO);
        redraw();
        return false;
    }
}